package com.capstone.petros.symbolapp;
...
public class SymbolActivity extends Activity {
    ...
    private float valueToSendBack = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(action == null){
            Toast.makeText(this, "No action received", Toast.LENGTH_LONG).show();
            // Finish when you export this shit.
        }
        if(action == "edu.umd.cmsc436.symbol.action.TRIAL"){
            isTrial = true;
        }
        ...
        testTimer = new CountDownTimer(90000, 100) {
            ...
            public void onFinish() {
                ...
                findViewById(R.id.symbolStartNumpadButton).setVisibility(View.INVISIBLE);
                findViewById(R.id.symbolStartVoiceButton).setVisibility(View.INVISIBLE);
                findViewById(R.id.symbolSpace).setVisibility(View.INVISIBLE);
                findViewById(R.id.symbolFinishTestButton).setVisibility(View.VISIBLE);
            }
        };
    ...
    public String getResults() {
        ...
        valueToSendBack = (float)(average/1000);
    ...
    public void finishTest(View view){
        if(isTrial){
            ...
            data.putExtra("score", valueToSendBack);
